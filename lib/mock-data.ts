...
export const CATEGORIES: Category[] = [
  ...
  { id: "agriculture", name: "Agriculture", nameTelugu: "వ్యవసాయం", slug: "agriculture", articleCount: 15, color: "#E67E22" },
  { id: "education", name: "Education", nameTelugu: "విద్య", slug: "education", articleCount: 10, color: "#9B59B6" },
  { id: "kamma-community", name: "Kamma Community", nameTelugu: "కమ్మ సమాజం", slug: "kamma-community", articleCount: 18, color: "#4A90D9" },
  { id: "ap-development", name: "Andhra Pradesh Development", nameTelugu: "ఆంధ్రప్రదేశ్ అభివృద్ధి", slug: "ap-development", articleCount: 20, color: "#D94A6B" },
];
...
export const MOCK_ARTICLES: Article[] = [
  makeArticle(1, {
    ...
    category: "kamma-community", categoryTelugu: "కమ్మ సమాజం",
  ...
  makeArticle(5, {
    ...
    category: "ap-development", categoryTelugu: "ఆంధ్రప్రదేశ్ అభివృద్ధి",
